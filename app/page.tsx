...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="relative pt-16 pb-20 bg-gradient-to-br from-burnt-orange-50 to-burnt-orange-100 hero-section">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:shadow-lg transition">
              ...
              <h3 className="text-xl font-semibold mb-2">Book Meeting Room</h3>
              <p className="text-gray-600 mb-4">Reserve our first-class meeting rooms with A/V equipment</p>
              <Link href="/meeting-rooms" className="bg-burnt-orange-600 text-white px-6 py-2 rounded-lg hover:bg-burnt-orange-700 transition inline-block">
                Book Now
              </Link>
            </div>
            
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:shadow-lg transition">
              <ShoppingCart className="w-12 h-12 text-burnt-orange-600 mx-auto mb-4" />
              ...
              <Link href="/snackshop" className="bg-burnt-orange-600 text-white px-6 py-2 rounded-lg hover:bg-burnt-orange-700 transition inline-block">
                Shop Now
              </Link>
            </div>
            
            <div className="text-center p-6 bg-gray-50 rounded-xl hover:shadow-lg transition">
              <UserPlus className="w-12 h-12 text-burnt-orange-600 mx-auto mb-4" />
              ...
              <Link href="/membership" className="bg-burnt-orange-600 text-white px-6 py-2 rounded-lg hover:bg-burnt-orange-700 transition inline-block">
                Apply Today
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="h-48 bg-gradient-to-br from-burnt-orange-100 to-burnt-orange-200"></div>
              <div className="p-6">
            ...
            {/* Private Offices */}
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="h-48 bg-gradient-to-br from-burnt-orange-200 to-burnt-orange-300"></div>
              <div className="p-6">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden md:col-span-2 lg:col-span-1">
              <div className="h-48 bg-gradient-to-br from-burnt-orange-300 to-burnt-orange-400"></div>
              <div className="p-6">
      ...
      <section className="py-20 bg-gradient-to-r from-burnt-orange-500 to-burnt-orange-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-burnt-orange-100 mb-8">Start with a free trial day to experience the space</p>
