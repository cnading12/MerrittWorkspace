...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Premium coworking in Sloan's Lake with member access to our stunning 1905 church. Dedicated desks $300/mo ($100/mo for first 10 members — locked in for life!), private offices from $500/mo. 24/7 access, 3 min to I-25.",
    images: [
      {
